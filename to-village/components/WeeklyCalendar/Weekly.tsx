...
export default function Weekly() {
  ...
  return (
    <div className="w-full pt-16 pb-5 bg-slate-200 rounded-b-3xl">
      <div className="text-center text-6xl font-semibold pb-8 ">
        {year}년 {month}월
      </div>
      <div className="text-xl w-full font-medium">
